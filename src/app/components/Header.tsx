        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden lg:flex items-center gap-3">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/gslo_official?igsh=MXU5YTdmemszdzB2bQ==" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 bg-black hover:bg-black/80 text-white rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
              ...
              {/* Facebook */}
              <a 
                href="https://facebook.com/gauravsharmalawofficials" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 bg-black hover:bg-black/80 text-white rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110"
                aria-label="Facebook"
