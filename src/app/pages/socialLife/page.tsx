...
export default function SocialLife() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* The Journey - Black Section with Image */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 items-center">
            ...
            >
              <div
                className="absolute inset-0"
                style={{
                  backgroundImage: `url('https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=800&h=1000&fit=crop')`,
                  backgroundPosition: 'center',
                  backgroundSize: 'cover',
      ...
      {/* Women Empowerment - Black Section with Image */}
      <section className="relative py-16 md:py-20 bg-black text-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div
                className="absolute inset-0"
                style={{
                  backgroundImage: `url('https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=800&h=1000&fit=crop')`,
                  backgroundPosition: 'center',
                  backgroundSize: 'cover',
                  filter: 'grayscale(100%)',
                }}
